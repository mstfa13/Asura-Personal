        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">Spanish</h1>
                <p className="text-gray-600 mt-1">Track your Spanish practice</p>
              </div>
            </div>
            <Dialog open={showAddHours} onOpenChange={setShowAddHours}>
              ...
              <DialogContent>
                <DialogHeader>
                  <DialogTitle>Add Spanish Hours</DialogTitle>
                </DialogHeader>
                ...
                <DialogFooter>
                  <Button onClick={handleAddHours} className="bg-yellow-600 hover:bg-yellow-700">Add Hours</Button>
      ...
      <Dialog open={editBooksOpen} onOpenChange={setEditBooksOpen}>
        <DialogContent>
          ...
          <Card className="relative overflow-hidden">
            ...
            <CardContent>
              <div className="text-2xl font-bold">{spanish.currentStreak}</div>
          ...
          <Card className="relative overflow-hidden">
            ...
            <CardContent>
              <div className="text-2xl font-bold">Level {spanishLevel}</div>
